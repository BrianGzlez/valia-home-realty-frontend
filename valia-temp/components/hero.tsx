...
export function Hero() {
  return (
    <section className="relative h-screen flex items-center justify-center bg-gradient-to-r from-valia-primary to-valia-primary-600">
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-20"
        style={{
          backgroundImage: "url('/luxury-real-estate-dr.png')",
        }}
      />

      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
        <h1 className="font-serif text-5xl md:text-7xl font-bold mb-6">Valía Home Realty</h1>
        <p className="text-xl md:text-2xl mb-8 opacity-90">Discover Premium Properties in the Dominican Republic</p>
